...
1. This project uses the [PEP8](https://www.python.org/dev/peps/pep-0008/) code style. You should follow the same before you create a pull request. You can use `black` to format your code quickly.
